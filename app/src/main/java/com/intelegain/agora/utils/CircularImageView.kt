 ...
 *
 *  Purpose:
 *  This class used for circular imageview
 */
class CircularImageView : AppCompatImageView {
    ...
    public override fun onDraw(canvas: Canvas) { // load the bitmap
        loadBitmap()
        // init shader
        if (image != null) {
...
// paint contains the shader that will texture the shape
            canvas.drawCircle(circleCenter + borderWidth.toFloat(), (circleCenter
                    + borderWidth).toFloat(), circleCenter + borderWidth.toFloat(), paint!!)
            canvas.drawCircle(circleCenter + borderWidth.toFloat(), (circleCenter
                    + borderWidth).toFloat(), circleCenter + borderWidth.toFloat(), paintBorder!!)
            canvas.drawCircle(circleCenter + borderWidth.toFloat(), (circleCenter
                    + borderWidth).toFloat(), circleCenter.toFloat(), paint!!)
        }
    }
    ...
    private fun measureWidth(measureSpec: Int): Int {
        ...
        result = if (specMode == MeasureSpec.EXACTLY) { // We were told how big to be
            specSize
